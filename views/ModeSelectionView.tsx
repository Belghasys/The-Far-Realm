...
export function ModeSelectionView() {
    ...
    const TRANS = {
        en: {
            ...
            solo: "Solo Journey",
            soloDesc: "Make all the terrible tactical choices yourself, with no party to blame you.",
            multi: "Gather Your Party",
            multiDesc: "Team up with friends in real time. Coming soon.",
            comingSoon: "Coming Soon",
            logout: "Log Out",
            arenaTitle: "ARENA MODE",
            arenaDesc: "Zero talking, zero diplomacy. Just you, monsters, and raw combat math.",
            ...
            tavernHint: "Grab a drink, mute the outside world, and spin the dungeon's favorite records.",
        ...
        fr: {
            ...
            solo: "Aventure Solo",
            soloDesc: "Prenez toutes les mauvaises décisions vous-même, sans personne pour vous juger.",
            multi: "Rassemblez Votre Groupe",
            multiDesc: "Jouez à plusieurs en temps réel. Bientôt disponible.",
            comingSoon: "Bientôt disponible",
            logout: "Déconnexion",
            arenaTitle: "MODE ARÈNE",
            arenaDesc: "Zéro blabla, zéro diplomatie. Juste vous, des monstres et des lancers de dés.",
            ...
            tavernHint: "Prenez une chope, coupez le bruit du monde et écoutez les vinyles du donjon.",
