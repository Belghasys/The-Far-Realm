...
const RARITY_ORDER: MagicItemRarity[] = ['common', 'uncommon', 'rare', 'very rare', 'legendary'];
...
function pickRarity(weights: Record<MagicItemRarity, number>, rng: () => number): MagicItemRarity {
