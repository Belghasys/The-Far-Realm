...
export const CB_MANIFESTO_WORLD: string =
  ...
  "1. (V) « Les disparus, on les a REVUS. Au bal. Ils souriaient. » 2. (D) « Une déesse elfe pleure sous le glacier— euh, sous les orgues. Enfin elle pleure quelque part. » 3. (F) « La Bannière du Fer a trouvé le trésor des Sept et le cache. » 4. (V) « Les drows achètent des secrets. Ils paient MIEUX que Tissa. » 5. (D) « Le grand érudit du bal ? Un prince elfe revenu d'exil, on dit. » 6. (V) « Les pavés qui chantent arrêtent les démons. Enfin... arrêtaient. » 7. (F) « Sereine vend nos itinéraires au culte, c'est forcé, elle sait TOUT. » 8. (V) « Frère Cadence creuse plus de tombes qu'on ne lui rend de corps. » 9. (D) « Le gamin fantôme de la fontaine porte malheur. » (Il porte exactement l'inverse.) 10. (V) « La nuit de la lune double, restez au camp. TOUTES les fenêtres seront allumées. »\n\n" +
