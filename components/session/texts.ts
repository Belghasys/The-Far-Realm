...
export const ACTION_PROMPT_TEXTS = {
    en: {
        ...
        useInspiration: 'Automatic success',
        inspirationLeft: (n: number) => `Inspiration: ${n}`,
        cancel: 'Cancel',
    },
    fr: {
        ...
        useInspiration: 'Réussite automatique',
        inspirationLeft: (n: number) => `Inspiration : ${n}`,
...
export const STATUS_BAR_TEXTS = {
    en: {
        ...
        inspirationTooltip: 'Inspiration in reserve — spend it on a roll for an automatic success',
    },
    fr: {
        halfCover: 'Demi-couvert',
        threeQuarterCover: '3/4 couvert',
        coverTooltipSuffix: 'CA contre les attaques à distance',
        inspirationTooltip: 'Inspiration en réserve — dépense-la sur un jet pour une réussite automatique',
        turnsShort: 'tour(s)',
        turnAbbrev: 't',
...
export const GAME_SESSION_TEXTS = {
  en: {
    ...
    statusHidden: 'Hidden',
    gsNowHidden: 'You slip out of sight — your next attack has advantage, and striking reveals you.',
    gsNoLongerHidden: 'You are spotted.',
  ...
  fr: {
    ...
    statusHidden: 'Caché',
    gsNowHidden: 'Tu disparais des regards — ta prochaine attaque aura l’avantage, et frapper te trahira.',
    gsNoLongerHidden: 'Tu es repéré.',
