...
import { AdventureManifest, CampaignRuntimeState, CharacterSheet, TimeOfDay, calculateLevelFromXP, getCombatAC, getEffectiveStat, getPlayerAttackModifier, getPlayerDamageBonus, getXPProgress, parseItemStatModifier, getPlayerAttackCount, racialHPBonusPerLevel, isRangedWeapon } from '../../types';
...
import { InventoryPanel, CharacterSheetPanel, toWeaponOverride } from '../panels/InGameMenus';
...
import { advanceClocksForNight, advanceTurn, applyDeathSaveOutcome, applyLongRest, applyShortRest, resolveConcentrationAfterDamage, resolvePendingSpellRoll, resolveRollPrompt, resolveAttackAction, consumeCombatAction, normalizeRollPrompt, applyStoryModifiersToPrompt, encounterOutcome, applyDamageToEncounter, applyConditionToEncounter, normalizeStoryModifier, tickRoundEffects, playerResistances, syncCompanionsFromState, worldHourOf, sweepExpiredEffects, stampEffectExpiry, releaseNpcConcentrationEffect, formatDamageParts, levelUpCompanions, getActionCapability, victoryXP } from '../../engine/rulesEngine';
...
import { playWeaponSwing, playDamageImpact, playDiceRoll, playEndTurn } from '../../services/media/combatSfx';
